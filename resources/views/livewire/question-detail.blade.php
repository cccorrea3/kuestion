        ...
        @if ($currentVersion)
            <div class="bg-surface rounded-xl shadow-sm border border-border p-5">
                ...
                <div class="flex flex-wrap items-center gap-4 mt-4 pt-4 border-t border-border text-xs text-text-muted">
                    ...
                    {{-- Ola 2 Punto 3 — B.2/B.3/B.4: indicador de vigencia completo, justo
                         después de la respuesta y antes de las fuentes (§2.2). Absorbe el
                         copy honesto P5/6 (sin_dato) y la acción Reconfirmar (B.4/C.1). --}}
                    ...
                    <x-vigencia-indicator
                        ...
                        action-method="reconfirmar"
                        action-target="reconfirmar"
                    />
            ...
            <div class="bg-surface rounded-xl shadow-sm border border-border p-5">
                <livewire:feedback-buttons :question="$question" wire:key="fb-{{ $question->id }}" />
            </div>
