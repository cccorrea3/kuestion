<div class="min-h-[80vh] flex items-center justify-center py-12 px-4">
    <div class="w-full max-w-sm">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-text tracking-tight">Nueva contraseña</h1>
            <p class="text-sm text-text-muted mt-1.5">Definí una contraseña nueva para tu cuenta</p>
        </div>

        <form wire:submit="resetPassword" class="relative bg-surface rounded-2xl shadow-sm border border-border p-8 space-y-5">
            @if ($error)
            ...
            <x-input label="Nueva contraseña" id="password" type="password" wire:model="password" required autocomplete="new-password" />
