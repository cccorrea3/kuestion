...
<head>
    ...
    <title>Kuestion: reconfirmación pendiente</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background-color:#ffffff;border-radius:16px;border:1px solid #e7e5e4;overflow:hidden;">
                    <tr>
                        <td style="padding:32px 32px 8px;">
                            <h1 style="margin:0;font-size:20px;line-height:1.3;color:#1c1917;">¿Sigue siendo válido este conocimiento?</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:8px 32px 0;">
                            <p style="margin:0;font-size:15px;line-height:1.6;color:#57534e;">
                                Hace <strong style="color:#1c1917;">{{ $dias }} días</strong> que nadie reconfirma la información detrás de tu pregunta. Si sigue vigente, confírmalo para mantener la confianza en tus respuestas.
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:20px 32px 0;">
                            ...
                            <p style="margin:0;font-size:16px;line-height:1.5;color:#1c1917;font-weight:600;">{{ $questionText }}</p>
                        </td>
                    </tr>
                    <tr>
