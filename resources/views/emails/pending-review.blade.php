...
<head>
    ...
    <title>Kuestion: aporte pendiente de revisión</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background-color:#ffffff;border-radius:16px;border:1px solid #e7e5e4;overflow:hidden;">
                    <tr>
                        <td style="padding:32px 32px 8px;">
                            <h1 style="margin:0;font-size:20px;line-height:1.3;color:#1c1917;">Hay un aporte esperando tu revisión</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:8px 32px 0;">
                            <p style="margin:0;font-size:15px;line-height:1.6;color:#57534e;">
                                @if ($autorNombre !== '' && $autorNombre !== 'Alguien')
                                    <strong style="color:#1c1917;">{{ $autorNombre }}</strong> aportó contenido que requiere tu revisión para incorporarse a la base de conocimiento.
                                @else
                                    Alguien aportó contenido que requiere tu revisión para incorporarse a la base de conocimiento.
                                @endif
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:20px 32px 0;">
                            <p style="margin:0 0 8px;font-size:13px;line-height:1.5;color:#78716c;">El aporte:</p>
